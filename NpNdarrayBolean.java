...
public class NpNdarrayBoolean extends NpNdarray {
    ...
    public NpNdarrayBolean(boolean[] data, int[] shape, int[] strides) {
        super(shape, strides);
        if (data == null) throw new NullPointerException("data = null");
        this.data = data;
    }

    public NpNdarrayBolean(boolean[] ary) {
    ...
    public NpNdarrayBolean(boolean[][] ary) {
        ...
        boolean[] data = new boolean[intAryProduct(shape)];
    ...
    public boolean equals(Object o) {
        ...
        NpNdarrayBolean that = (NpNdarrayBolean) o;
    ...
    public boolean[] toArray() {
        ...
        if (strides[0] == 1 && data.length == shape[0]) {
            ...
            int[] strides = this.strides;
            boolean[] ary = new boolean[shape[0]];
    ...
    public boolean[][] toArray2d() {
        ...
        int[] strides = this.strides;
        boolean[][] ary = new boolean[shape[0]][shape[1]];
        for (int i = 0; i < ary.length; i++) {
    ...
    public boolean[][][] toArray3d() {
        ...
        int[] strides = this.strides;
        boolean[][][] ary = new boolean[shape[0]][shape[1]][shape[2]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
    ...
    public boolean[][][][] toArray4d() {
        if (ndim() != 4) throw new RuntimeException("ndim != 4");

        int[] strides = this.strides;
        boolean[][][][] ary = new boolean[shape[0]][shape[1]][shape[2]][shape[3]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
    ...
    public boolean[][][][][] toArray5d() {
        if (ndim() != 5) throw new RuntimeException("ndim != 5");

        int[] strides = this.strides;
        boolean[][][][][] ary = new boolean[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public boolean[][][][][][] toArray6d() {
        if (ndim() != 6) throw new RuntimeException("ndim != 6");

        int[] strides = this.strides;
        boolean[][][][][][] ary = new boolean[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public boolean[][][][][][][] toArray7d() {
        if (ndim() != 7) throw new RuntimeException("ndim != 7");

        int[] strides = this.strides;
        boolean[][][][][][][] ary = new boolean[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]][shape[6]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
    ...
    public boolean[][][][][][][][] toArray8d() {
        if (ndim() != 8) throw new RuntimeException("ndim != 8");

        int[] strides = this.strides;
        boolean[][][][][][][][] ary = new boolean[shape[0]][shape[1]][shape[2]][shape[3]][shape[4]][shape[5]][shape[6]][shape[7]];
        for (int i = 0; i < ary.length; i++) {
            for (int j = 0; j < ary[i].length; j++) {
                for (int k = 0; k < ary[i][j].length; k++) {
                    for (int l = 0; l < ary[i][j][k].length; l++) {
